...
public class GameSettings {
    ...
    public GameSettings() {
        try {
            FileReader reader = new FileReader("src/main/resources/settings.properties");
    ...
    public void setProperty(Stats type, String value) {
        switch (type) {
            case MINES:
                settings.setProperty("m", value);
                break;
            case WIDTH:
                settings.setProperty("w", value);
                break;
            case HEIGHT:
                settings.setProperty("h", value);
                break;
        }
    }
